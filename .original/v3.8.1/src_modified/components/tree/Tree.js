...
`<div class="row">
  ...
  constructor(component, options, data) {
    ...
    this.templateHash = {
      edit: Utils.addTemplateHash(this.component.template.edit || TreeComponent.defaultEditTemplate), // ?. lwf
      view: Utils.addTemplateHash(this.component.template.view || TreeComponent.defaultViewTemplate), // ?. lwf
      child: Utils.addTemplateHash(this.component.template.child || TreeComponent.defaultChildTemplate), // ?. lwf
      children: Utils.addTemplateHash(this.component.template.children || TreeComponent.defaultChildrenTemplate), // ?. lwf
    };
  }

  getComponents() {
    return this.tree.getComponents() || super.getComponents(); // ?. lwf
  }

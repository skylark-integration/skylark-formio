define([
    ...
    '../../formio.form'
], function (Two, NestedComponent, _, BaseComponent, a) {
    'use strict';
    return class Tagpad extends NestedComponent {
        ...
        renderTagpad() {
            this.tagpadContainer = this.ce('div', { class: 'formio-tagpad-container clearfix' });
            this.canvas = this.ce('div', { class: 'formio-tagpad-canvas' });
            ...
            }, this.form = this.ce('div', { class: 'formio-tagpad-form' }));
            this.renderForm();
        ...
        renderForm() {
            this.form.appendChild(this.ce('p', { class: 'formio-tagpad-form-title' }, [
                this.t('Dot: '),
                this.selectedDotIndexElement = this.ce('span', {}, 'No dot selected')
            ]));
            this.component.components.forEach(component => {
                const componentInstance = a.Components.create(component, this.options, this.data);
            ...
            this.form.appendChild(this.ce('button', {
                ...
                title: 'Remove Dot'
            }, [this.ce('i', { class: this.iconClass('trash') })]));
        }
        attachDrawEvents() {

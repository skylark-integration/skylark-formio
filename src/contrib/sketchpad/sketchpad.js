define([
    ...
    'vanilla-picker',
    'lodash'
], function (Base, Two, Picker, _) {
    'use strict';
    return class Sketchpad extends Base {
        ...
        editSvg() {
            ...
            const metaInfoContainer = this.ce('div', { class: 'formio-sketchpad-meta-info' }, this.ce('span', {}, [
            ...
            this.saveSvgButton = this.ce('button', { class: 'btn btn-success formio-sketchpad-save-button' }, this.t('Save'));
            ...
            return this.ce('div', {
                ...
                this.ce('div', {
                    ...
                    const toolbarButton = this.ce('div', {
                        ...
                        title: mode.title
                    }, this.ce('i', { class: `fa fa-${ mode.icon }` }));
                    if (mode.attach) {
                ...
                this.ce('div', {
                    ...
                    const toolbarButtonIcon = this.ce('i', { class: `fa fa-${ button.icon }` });
                    const toolbarButton = this.ce('div', {
                ...
                this.ce('div', {
                    ...
                    title: button.title
                }, this.ce('i', { class: `fa fa-${ button.icon }` }))))
            ]);
        }
        attach() {
            this.editSvgElement.addEventListener('mousedown', e => {
                e.preventDefault();
                ...
                const mouseEnd = e => {
                    e.preventDefault();
                    this.editSvgElement.removeEventListener('mousemove', mouseDrag);
                    this.editSvgElement.removeEventListener('mouseup', mouseEnd);
                    let cursor = 'default';
                    if (this.modes[this.state.mode].cursor) {
                ...
                this.editSvgElement.addEventListener('mousemove', mouseDrag);
                this.editSvgElement.addEventListener('mouseup', mouseEnd);
                return false;
            });
            this.editSvgElement.addEventListener('touchstart', e => {
                e.preventDefault();
                const offset = this.editSvgElement.getBoundingClientRect();
                ...
                const touchEnd = e => {
                    e.preventDefault();
                    this.editSvgElement.removeEventListener('touchmove', touchDrag);
                    this.editSvgElement.removeEventListener('touchend', touchEnd);
                    const offset = this.editSvgElement.getBoundingClientRect();
                    const touch = e.originalEvent.changedTouches[0];
                    let cursor = 'default';
                    if (this.modes[this.state.mode].cursor) {
                ...
                this.editSvgElement.addEventListener('touchmove', touchDrag);
                this.editSvgElement.addEventListener('touchend', touchEnd);
                return false;
            });
            this.two.update();
        }
        ...
        normalizeSvgOffset() {
            ...
            const maxOffsetX = this.component.width - this.zoomInfo.viewBox.width, maxOffsetY = this.component.height - this.zoomInfo.viewBox.height;

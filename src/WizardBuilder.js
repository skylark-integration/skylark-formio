define([
    ...
    return class WizardBuilder extends WebformBuilder {
        ...
        addComponents(element, data, options, state) {
            ...
            _.each(components, (component, index) => this.addComponent(component, element, data, null, index !== this.currentPage, this.getComponentState(component, state)));
        }
        gotoPage(page) {
        ...
        buildPageBar() {
            ...
            _.each(pages, (page, index) => {
                const pageLink = this.ce('span', {
                    title: page.title,
                    class: index === this.currentPage ? 'mr-2 badge badge-primary bg-primary label label-primary wizard-page-label' : 'mr-2 badge badge-info bg-info label label-info wizard-page-label'

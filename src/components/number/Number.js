define([
    ...
    '../base/Base',
    '../../utils/utils'
], function (a, _, b, BaseComponent, c) {
    'use strict';
    return class NumberComponent extends BaseComponent {
        ...
        constructor(component, options, data) {
            ...
            const separators = c.getNumberSeparators(this.options.language);
            ...
            this.decimalLimit = c.getNumberDecimalLimit(this.component);
            ...
            this.numberMask = b.createNumberMask({
                prefix: '',
                suffix: '',
        ...
        getMaskedValue(value) {
            return a.conformToMask(value.toString(), this.numberMask).conformedValue;
        }
        createInput(...args) {

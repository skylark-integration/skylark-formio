define([
    ...
    'use strict';
    return class ButtonComponent extends BaseComponent {
        ...
        build() {
            ...
            if (this.component.leftIcon) {
                this.buttonElement.appendChild(this.ce('span', { class: this.component.leftIcon }));
            ...
            if (this.component.rightIcon) {
                this.buttonElement.appendChild(this.text('\xA0'));
                this.buttonElement.appendChild(this.ce('span', { class: this.component.rightIcon }));
            }
            let onChange = null;
            let onError = null;
            ...
            this.addEventListener(this.buttonElement, 'click', event => {
                ...
                case 'submit':
                    ...
                    this.emit('submitButton', { state: this.component.state || 'submitted' });
                    break;
                case 'event':
        ...
        triggerReCaptcha() {
            ...
            this.root.everyComponent(component => {
                if (component.component.type === 'recaptcha' && component.component.eventType === 'buttonClick' && component.component.buttonKey === this.component.key) {

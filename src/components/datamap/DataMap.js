define([
    ...
    'lodash',
    '../../utils/utils'
], function (BaseComponent, NestedComponent, _, a) {
    'use strict';
    return class DataMapComponent extends NestedComponent {
        ...
        hasRemoveButtons() {
            return !this.component.disableAddingRemovingRows && !this.shouldDisable && !this.options.builder && Object.keys(this.dataValue).length > _.get(this.component, 'validate.minLength', 0);
        }
        ...
        build(state) {
            ...
            this.tableElement = this.ce('table', { class: tableClass });
        ...
        addKeyButton() {
            ...
            addButton.appendChild(this.ce('i', { class: this.iconClass('plus') }));
        ...
        removeKeyButton(key) {
            ...
            removeButton.appendChild(this.ce('i', { class: this.iconClass('remove-circle') }));
            return removeButton;
        }
        createHeader() {
            const valueHeader = this.ce('th', { 'class': 'col-9 col-sm-8' }, this.text(this.component.valueComponent.label));
            if (this.component.valueComponent.tooltip) {
                this.createTooltip(valueHeader, { tooltip: this.t(this.component.valueComponent.tooltip) });
            }
            const keyHeader = this.ce('th', { 'class': 'col-2 col-sm-3' }, this.text('Key'));
            this.createTooltip(keyHeader, { tooltip: this.t('Enter the map "key" for this value.') });
            return this.ce('thead', null, this.ce('tr', { class: 'd-flex' }, [
        ...
        createValueComponent(state) {
            const container = this.ce('td', { class: 'col-9 col-sm-8' });
        ...
        addRow() {
            ...
            const key = a.uniqueKey(this.dataValue, _.camelCase(component.value.defaultValue) || 'key');

define([
    ...
    'use strict';
    return class RadioComponent extends BaseComponent {
        ...
        createInput(container) {
            const inputGroup = this.ce('div', { class: 'form-group' });
            ...
            _.each(this.component.values, value => {
                ...
                const labelWrapper = this.ce('div', { class: wrapperClass });
                const label = this.ce('label', { class: 'control-label form-check-label' });
        ...
        optionsLabelOnTheTopOrLeft() {
            return [
                'top',
                'left'
            ].includes(this.component.optionsLabelPosition);
        }

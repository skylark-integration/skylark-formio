define([
    ...
    '../base/Base',
    '../../utils/utils'
], function (_, BaseComponent, a) {
    'use strict';
    return class DayComponent extends BaseComponent {
        ...
        createDayInput(subinputAtTheBottom) {
            const dayColumn = this.ce('div', { class: 'form-group col col-xs-3' });
            const id = `${ this.component.key }-day`;
            const dayLabel = !this.hideInputLabels ? this.ce('label', {
                for: id,
        ...
        createMonthInput(subinputAtTheBottom) {
            const monthColumn = this.ce('div', { class: 'form-group col col-xs-4' });
            const id = `${ this.component.key }-month`;
            const monthLabel = !this.hideInputLabels ? this.ce('label', {
                for: id,
        ...
        createYearInput(subinputAtTheBottom) {
            const yearColumn = this.ce('div', { class: 'form-group col col-xs-5' });
            const id = `${ this.component.key }-year`;
            const yearLabel = !this.hideInputLabels ? this.ce('label', {
                for: id,

define([
    ...
    'use strict';
    return class TextFieldComponent extends BaseComponent {
        ...
        createInput(container) {
            ...
            const inputGroup = this.ce('div', { class: 'input-group formio-multiple-mask-container' });
        ...
        addCounter(container) {
            ...
            if (_.get(this.component, 'showCharCount', false)) {
                ...
                this.charCount = this.ce('span', { class: 'text-muted pull-right' });
        ...
        setCounter(type, element, count, max) {
            if (max) {
                ...
                element.innerHTML = this.t(`{{ remaining }} ${ type } remaining.`, { remaining: remaining });
            } else {
                element.innerHTML = this.t(`{{ count }} ${ type }`, { count: count });
            }
        }
        ...
        setValueAt(index, value, flags) {
            ...
            if (!value) {
                if (defaultValue) {
                    ...
                    value = { maskName: this.component.inputMasks[0].label };
                }
            }

define([
    ...
    './Formio',
    './Webform'
], function (Promise, _, Formio, Webform) {
    'use strict';
    return class PDF extends Webform {
        ...
        build() {
            ...
            }, this.ce('i', { class: this.iconClass('zoom-in') }));
            ...
            this.zoomOut = this.ce('span', {
                ...
                class: 'btn btn-default btn-secondary no-disable'
            }, this.ce('i', { class: this.iconClass('zoom-out') }));
            ...
            if (!this.options.readOnly && _.find(this.form.components, component => component.type === 'button' && component.action === 'submit')) {
